...
public interface IXtreamClient
{
    ...
    Task<IReadOnlyList<Channel>> GetAllLiveStreamsAsync(CancellationToken ct);
    ...
    Task<IReadOnlyList<Movie>> GetAllVodStreamsAsync(CancellationToken ct);
    ...
    Task<IReadOnlyList<Series>> GetAllSeriesAsync(CancellationToken ct);
